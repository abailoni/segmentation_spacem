...
if __name__ == '__main__':
    ...
    sys.argv = process_speedrun_sys_argv(sys.argv, source_path,
                                         ...
                                         default_exp_dir_path="/scratch/bailoni/projects/cellpose_inference_projects/test_segm_tool" # Where to save the results (logs, checkpoints, segmentation results, etc.)
                                         )
